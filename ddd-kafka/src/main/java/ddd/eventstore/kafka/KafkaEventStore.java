...
import ddd.eventstore.EventStoreException;
 ...
 * @see ddd.eventstore.kafka.KafkaEventStoreOptimisticLockingStrategy
 */
        ...
        try {
            ...
            try {
                ...
                if (strategy != KafkaEventStoreOptimisticLockingStrategy.SINK) {
                    ...
                    try {
                        acquired = lock.get().acquire(300, TimeUnit.MILLISECONDS);
                        if (acquired) {
